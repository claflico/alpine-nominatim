...
NGINX_SSL_DIR=${NGINX_SSL_DIR:-${CONF_DIR}"/ssl"}
NGINX_SSL_KEY_FILE=${NGINX_SSL_KEY_FILE:-${NGINX_SSL_DIR}"/"${SERVICE_NAME}".key"}
NGINX_SSL_CRT_FILE=${NGINX_SSL_CRT_FILE:-${NGINX_SSL_DIR}"/"${SERVICE_NAME}".crt"}
